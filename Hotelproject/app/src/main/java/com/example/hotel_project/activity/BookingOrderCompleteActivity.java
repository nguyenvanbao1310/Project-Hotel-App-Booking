...
public class BookingOrderCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BookingOrderCompleteActivity.this, WriteReviewActivity.class);
        ...
        btnBookAgain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingOrderCompleteActivity.this, HotelDetailActivity.class);
