...
import com.example.hotel_project.model.HotelBookingDTO;
...
public class BookingOrderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotel = (HotelBookingDTO)  getIntent().getSerializableExtra("hotelDTO");
        ...
        btnAddReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BookingOrderDetailActivity.this, WriteReviewActivity.class);
                intent.putExtra("bookingOrder", bookingOrderDTO);
        ...
        btnBookAgain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingOrderDetailActivity.this, HotelDetailActivity.class);
