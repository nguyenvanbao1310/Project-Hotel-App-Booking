    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerify.setOnClickListener(v -> {
            ...
            if (otp1.isEmpty() || otp2.isEmpty() || otp3.isEmpty() || otp4.isEmpty()) {
                Toast.makeText(OtpActivity.this, "Please enter all OTP digits.", Toast.LENGTH_SHORT).show();
                return;
            }
        ...
        btnChange.setOnClickListener(v -> {
            if (email == null || email.isEmpty()) {
                Toast.makeText(OtpActivity.this, "Email không hợp lệ", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            apiService.resendOtp(resendRequest).enqueue(new Callback<Map<String, String>>() {
                ...
                public void onResponse(Call<Map<String, String>> call, Response<Map<String, String>> response) {
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(OtpActivity.this, "Không thể gửi lại mã OTP", Toast.LENGTH_SHORT).show();
                    }
                }
